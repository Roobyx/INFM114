...
<section class="user-box second-box">
		...
		<div class="card activity">
			<span class='status is-wait'> Текуща седмица: </span> 
			<?php 
		...
		<div class="card activity">
			<span class='status is-wait'> Текущ семестър: </span>
			<?php 
		...
		<div class="card activity">
			<span class='status is-wait'> Предстояща сесия:  </span>
			<?php 
		...
		<div class="card activity">
			<span class='status is-wait'> Опресни данните:  </span>
	...
	<div class="cards-wrapper">
		...
		<div class="cards-header">
			...
			<!-- <div class='in-table-cta'>
				<form method="post" action="home" method="post">
					<button class='button offer-button' name='resetVirginStatus'> Опресни графика </button>
				</form>
			</div> -->
